    ...
    <section id="about" className="section-padding">
      <div className="container-professional">
        ...
        <div className="glass" style={{ maxWidth: '50rem', marginLeft: 'auto', marginRight: 'auto', marginBottom: '3rem', padding: '2rem', borderLeft: '2px solid var(--yzy-construction)' }}>
          ...
          <p className="text-body" style={{ marginBottom: '1.5rem' }}>
            MY FIRST DEVELOPER ROLE WHERE I CAN CONTRIBUTE AND LEARN FROM DAY ONE. I AM STRONGEST IN FULL STACK AND SECURITY-FOCUSED DEVELOPMENT. I HAVE AN ACTIVE CLEARANCE FOR GOVERNMENT AND DEFENSE WORK. MOST IMPORTANTLY, I WANT TO JOIN A TEAM OF SOLID ENGINEERS AND GOOD PEOPLE WHERE I CAN LEARN FAST AND DELIVER QUALITY WORK.
          </p>
