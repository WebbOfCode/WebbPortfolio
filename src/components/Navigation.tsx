...
export default function Navigation() {
  ...
  return (
      // main nav bar with terminal styling
          ...
          <div className="flex-shrink-0 flex items-center space-x-4">
            ...
            <button
              ...
              className={`w-6 h-6 bg-gray-800/50 border border-gray-600/30 flex items-center justify-center font-mono text-xs transition-colors duration-350 ${
                ...
                // shows remaining clicks in tooltip
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              {navItems.map((item) => (
                ...
                >
                  {item.label}
                      // external link icon - pretty nice looking
                  {item.external && (
                  ...
                  // resume download with terminal command styling  
              <a
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-black border border-green-500/30 mb-4">
              {navItems.map((item) => (
                ...
                >
                  ...
                  {item.label}
                          // external link icon for mobile too
                  {item.external && (
                    <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
